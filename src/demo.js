...
export default function MiniDrawer() {
 ...
 //Index State---> will store the key of the active card (Can be used to find data by comparing with the key)
 const [index, setIndex] = React.useState(-1);

 //Email State---> will store the Emails which is being used in share insight modal.
 const [emails, setEmails] = React.useState();

 //Share Insight Related States and Methods
 const [openShareModal, setShareEditModal] = React.useState(false);
 const onOpenShareModal = () => setShareEditModal(true);
 const onCloseShareModal = () => {
   setEmails([]);
   setShareEditModal(false);
 };
 const [isDisabledSharedInsightButton, setIsDisabledSharedInsightButton] =
   React.useState(true);

 //Edit Insight Related States and Methods
 const [openEditModal, setOpenEditModal] = React.useState(false);
 const onOpenEditModal = () => setOpenEditModal(true);
 const onCloseEditModal = () => setOpenEditModal(false);
 const [editModalInputValue, setEditModalInputValue] = React.useState("");
 const [isDisabledFilledBtnEditModal, setIsDisabledFilledBtnEditModal] =
   React.useState(true);

 //Delete Insight Related States and Methods
 ...
 //Bookmark Insight Related Stated and Methods
 ...
 const [bookmarkModalInputValue, setBookmarkModalInputValue] =
   React.useState("");
 const [isDisabledFilledBtnSaveModal, setIsDisabledFilledBtnSaveModal] =
   React.useState(true);

 //See All Modal Related States and Methods
 ...
 //These are the tester functions which can be used for CTA to filled and link button(cancel and update buttons)
 const testerFunctionFilled = () => console.log("insideFilled");
 const testerFunctionLinked = () => console.log("insideLinked");

 //Explore Insight component related States and Methods
 const [showExploreInsight, setShowExploreInsight] = React.useState(true);
 const onClickExploreInsight = () => {
   setShowExploreInsight(false);
 };
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        insights_data={[
          ...
          },
          {
            ...
            "images": "https://assets.stylumia.com/w_400_h_auto/jpg/2021/06/67/efdbbee467420e1a3d420c5294523dbb20aeed9add2653fb7ece4e5e815cde13.jpg",
            "edited_field": [
              {
                "edited_key": "Categories",
                "edited_value": "2"
          ...
          },
          {
            ...
            "images": "https://assets.stylumia.com/w_400_h_auto/jpg/2020/01/8/8910200bf5d117f3b43c764181edea0f9888e6024f9978a2a30ce5e1d3787ebd.jpg",
            "isStarred": true,
            "edited_field": [
              {
                "edited_key": "Categories",
        ...
        cardToBeShowed={5}
        bookmarkInsightActionProps={{
          bookmark_modal_open: openBookmarkModal,
          onClickBookmark: onOpenBookmarkModal,
          onCloseBookmarkModal: onCloseBookmarkModal,
          bookmarkModalInputValue: bookmarkModalInputValue,
          setBookmarkModalInputValue: setBookmarkModalInputValue,
          isDisabledFilledBtnSaveModal: isDisabledFilledBtnSaveModal,
          setIsDisabledFilledBtnSaveModal: setIsDisabledFilledBtnSaveModal,
        ...
        ExploreInsightsCardProps={{
          showExploreInsight: showExploreInsight,
          onClickExploreInsight: onClickExploreInsight,
        }}
        shareInsightActionProps={{
          share_modal_open: openShareModal,
          onClickShare: onOpenShareModal,
          onCloseShareModal: onCloseShareModal,
          isDisabledSharedInsightButton: isDisabledSharedInsightButton,
          setIsDisabledSharedInsightButton: setIsDisabledSharedInsightButton,
        ...
        editInsightActionProps={{
          edit_modal_open: openEditModal,
          editModalInputValue: editModalInputValue,
          setEditModalInputValue: setEditModalInputValue,
          isDisabledFilledBtnEditModal: isDisabledFilledBtnEditModal,
          setIsDisabledFilledBtnEditModal: setIsDisabledFilledBtnEditModal,
